...
Work in the augur repo root. Read **`pitis/README.md`** (current
state + architecture) for the exact potrace/magick pipeline
...
(load the space's `skills/frontend-design/SKILL.md`; do NOT pull the space UI kit). `node build.js` must
