...
test("every statement executes against a real SQLite engine", () => {
  ...
  assert.deepEqual(tables, ["blobs", "invites", "lastseen", "members", "meta", "publish_tokens", "publish_versions", "quotas", "settings", "signing_keys"]);
});
...
test("the store exposes no read or write verb it does not yet need", () => {
  ...
  assert.deepEqual(names.sort(), [
    "fetch", "init", "isProvisioned", "members", "nextPublishVersion", "provision",
