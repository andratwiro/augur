 ...
 *
 * `prune` says "this family is exactly this and nothing else" for the families the document
 * carries: keys it does not name are removed. A plain restore says "at least this".
 *
 * It is opt-in and defaults off, because a restore must not be destructive on the strength
...
async function importState(tctx, env, doc) {
  ...
  return { ok: true, atomic: false, workspaceObject: false, ...out };
}
...
export const __testables = Object.freeze({
  ...
  deleteWorkspace, purgeDue, blobGc,
